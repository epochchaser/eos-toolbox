        ...
        <div className="container">
          <div className="row">
            <div className="col-md-6">
              ...
              <button type="button" className="btn btn-secondary" id="primary-popover-content" data-container="body" data-toggle="popover" title="Primary color states" data-placement="bottom" onClick={this.loginClick}>
                try login >
              </button>
            </div>
            <div className="col-md-6">
