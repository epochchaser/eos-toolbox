...
import Tooltips from './RamTooltips'
import HoverLine from './RamHoverLine'
import MaxPrice from './RamMaxPrice'
import MinPrice from './RamMinPrice'
    ...
    return (
      <div>
        <svg ref={s => (this.svg = s)} width={parentWidth} height={parentHeight}>
          ...
          <LinearGradient id="dLines" from="#4099ff" to="#4099ff" fromOpacity={0.2} toOpacity={1} />
          {/* <PatternLines
            id="dLines"
            height={6}
            width={6}
...
export default withTooltip(RamChart)
