...
YUI.add(
    ...
    Y.ScrollView = Y.extend(
      ...
      Y.Widget,
      {
          ...
          if (!this._cDisabled) {
            ...
            if (duration !== 0) {
              ...
              if (NATIVE_TRANSITIONS) {
                ...
                if (xSet) {
                  cb.setStyle(LEFT, xMove + PX)
                }
                if (ySet) {
                  cb.setStyle(TOP, yMove + PX)
                }
              }
            }
          }
        ...
        _transform: function(x, y) {
          ...
          return this._forceHWTransforms
        ...
        _onGestureMoveEnd: function(e) {
          ...
          // Check for halfway
          if (
            (horiz && absDistance > bb.get('offsetWidth') / 2) ||
            (vert && absDistance > bb.get('offsetHeight') / 2)
          ) {
  ...
  '3.4.0',
  { requires: ['widget', 'event-gestures', 'transition'], skinnable: true }
)
